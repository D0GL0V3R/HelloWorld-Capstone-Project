...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 19, 2025 at 11:15 AM
...
INSERT INTO `classes` (`class_id`, `class_name`, `description`, `max_participants`, `schedule_date`, `start_time`, `end_time`, `trainer_id`) VALUES
(1, 'Yoga Flow', 'A relaxing yoga session focused on flexibility and mindfulness.', 20, '2025-01-20', '08:00:00', '09:00:00', 1),
(2, 'Zumba Dance', 'High-energy dance workout to improve cardiovascular fitness.', 25, '2025-01-20', '10:00:00', '11:00:00', 5),
(3, 'Strength Training', 'Build muscle strength through resistance training and weightlifting.', 15, '2025-01-21', '15:00:00', '16:30:00', 8),
(4, 'Cardio Blast', 'A dynamic cardio session to burn calories and boost endurance.', 20, '2025-01-21', '18:00:00', '19:00:00', 5),
(5, 'Pilates Core', 'Focused on improving core strength, posture, and flexibility using Pilates.', 18, '2025-01-22', '07:30:00', '08:30:00', 8),
(6, 'Functional Fitness', 'Improve everyday movements through functional strength and agility exercises.', 15, '2025-01-22', '17:00:00', '18:30:00', 1),
(7, 'HIIT', 'High-Intensity Interval Training session for maximum calorie burn in less time.', 20, '2025-01-23', '06:00:00', '06:45:00', 1),
(8, 'Boxing Basics', 'A beginner-friendly boxing class focusing on technique and fitness.', 12, '2025-01-23', '19:00:00', '20:00:00', 1);
...
INSERT INTO `user` (`user_id`, `username`, `role`, `name`, `gender`, `email`, `password`, `contact_number`, `date_of_birth`, `profile_picture`, `height`, `weight`, `fitness_goals`) VALUES
(1, 'ali123', 'trainer', 'Ali', 'Male', 'ali@gmail.com', 'qwe', '012-3456999', '2005-02-12', 'profile_pictures/1.webp', 180.0, 70.0, 'Muscle Mass Gain'),
(2, 'sarahh', 'member', 'Sarah Jones', 'Female', 'sarah@hotmail.com', 'sa', '014-2312312', '2003-08-21', 'profile_pictures/2.jpg', 155.0, 50.0, 'Gain Weight'),
(3, 'admingod', 'admin', 'Guillaume Charnock', 'Male', 'gcharnock2@freewebs.com', '123', '+86 720 480 6295', '2024-02-09', 'profile_pictures/3.jpg', 102.4, 144.2, 'Lose Weight'),
(4, 'tgurry3', 'member', 'Tobias Gurry', 'Male', 'tgurry3@furl.net', 's1$fQg', '+62 531 921 9774', '2024-03-08', 'profile_pictures/4.webp', 116.8, 148.9, 'Shape Body'),
(5, 'jclick', 'trainer', 'Jena Click', 'Female', 'jclick4@addthis.com', '1823husad', '+62 274 401 4663', '2024-03-27', 'profile_pictures/5.webp', 182.4, 92.9, 'Muscle Mass Gain'),
(6, 'msterman5', 'admin', 'Moises Sterman', 'Male', 'msterman5@wisc.edu', 'o2LMakpo', '+81 460 392 6175', '2024-08-11', 'profile_pictures/6.png', 151.5, 165.7, 'Loss Weight'),
(7, 'emalins6', 'member', 'Emmaline Malins', 'Female', 'emalins6@cbsnews.com', 'm3os8iN?}', '+52 497 559 5494', '2024-09-30', 'profile_pictures/7.jpg', 162.6, 143.9, 'Lose Weight'),
(8, 'skristoffersen7', 'trainer', 'Saundra Kristoffersen', 'Male', 'skristoffersen7@skyrock.com', 'g9Bvchb9', '+86 334 481 4896', '2024-09-07', 'profile_pictures/8.jpg', 129.3, 173.3, 'Lose Weight'),
(9, 'hlaba8', 'member', 'Harmonia Laba', 'Female', 'hlaba8@jiathis.com', 'u9HTJ', '+86 552 884 9707', '2024-08-10', 'profile_pictures/9.jpg', 158.5, 135.6, 'Shape Body'),
(10, 'hmackrell9', 'member', 'Hildegarde Mackrell', 'Female', 'hmackrell9@dailymail.co.uk', 'k6}b%C0UpE', '+1 141 678 0030', '2024-12-26', 'profile_pictures/10.jpg', 194.4, 123.1, 'Muscle Mass Gain');
...
(1, 'Beginner Strength Training', 'A basic strength training program for beginners.', 'Beginner', NULL),
(2, 'Intermediate Fat Burn', 'A cardio and strength mix for fat loss.', 'Intermediate', NULL),
(3, 'Advanced Muscle Building', 'An advanced plan focused on muscle hypertrophy.', 'Advanced', NULL),
(4, 'Full-Body Fitness', 'A full-body workout program to improve overall fitness.', 'Beginner', NULL),
(5, 'Endurance Booster', 'Cardio-focused workouts for improving endurance.', 'Intermediate', NULL),
(6, 'Core and Stability Training', 'Focused on core strength and stability exercises.', 'Advanced', NULL);
